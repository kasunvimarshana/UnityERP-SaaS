...
class UpdateTaxJurisdictionRequest extends FormRequest
{
    ...
    {
        $jurisdictionId = $this->route('tax_jurisdiction');

        return [
            'name' => ['sometimes', 'required', 'string', 'max:255'],
            'code' => ['sometimes', 'required', 'string', 'max:50', 'unique:tax_jurisdictions,code,' . $jurisdictionId],
            'jurisdiction_type' => ['sometimes', 'required', 'in:country,state,city,postal_code,custom'],
