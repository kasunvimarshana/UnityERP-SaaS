...
class StoreWorkOrderRequest extends FormRequest
{
    ...
    {
        return true; // Add policy check: $this->user()->can('create', WorkOrder::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'work_order_number' => ['nullable', 'string', 'max:50', 'unique:work_orders,work_order_number'],
            'reference_number' => ['nullable', 'string', 'max:100'],
            'status' => ['nullable', 'in:draft,planned,released,in_progress,completed,cancelled'],
            'priority' => ['nullable', 'in:low,normal,high,urgent'],
            'planned_quantity' => ['required', 'numeric', 'min:0.0001', 'max:999999999.9999'],
