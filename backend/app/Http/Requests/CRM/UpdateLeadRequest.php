...
class UpdateLeadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => ['sometimes', 'string', 'max:50', 'unique:leads,code,' . $leadId],
            ...
            'source' => ['sometimes', 'in:website,referral,social_media,email_campaign,cold_call,trade_show,advertisement,partner,other'],
