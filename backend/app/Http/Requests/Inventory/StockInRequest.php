...
class StockInRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'transaction_type' => ['required', 'in:purchase,return,adjustment_in,production,transfer_in'],
    ...
    public function messages(): array
    {
        return [
            ...
            'transaction_type.in' => 'Invalid transaction type for stock IN operation',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($this->filled('serial_number')) {
                ...
                if ($exists) {
                    $validator->errors()->add('serial_number', 'This serial number is already in stock');
                }
            }
        });
    }
